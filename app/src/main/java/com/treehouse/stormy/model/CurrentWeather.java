...
public class CurrentWeather {
    ...
    public CurrentWeather(String locationLabel, String summary, String icon, long time, double temperature, double humidity, double precipChance, String timezone) {
